...
EXTRN_MDL_SOURCE_BASEDIR_ICS="/data/static/model_data/FV3GFS"
EXTRN_MDL_FILES_ICS="gfs.pgrb2.0p25.f000"
EXTRN_MDL_SOURCE_BASEDIR_LBCS="/data/static/model_data/FV3GFS"
EXTRN_MDL_FILES_LBCS=( \
"gfs.pgrb2.0p25.f006" \
"gfs.pgrb2.0p25.f012" \
"gfs.pgrb2.0p25.f018" \
...
GRID_DIR="/data/experiments/test_CONUS_25km_GFSv15p2/grid"

RUN_TASK_MAKE_OROG="TRUE"
OROG_DIR="/data/experiments/test_CONUS_25km_GFSv15p2/orog"

RUN_TASK_MAKE_SFC_CLIMO="TRUE"
SFC_CLIMO_DIR="/data/experiments/test_CONUS_25km_GFSv15p2/sfc_climo"
#
#-----------------------------------------------------------------------
#
...
FIXgsm="/data/static/fix_am"
TOPO_DIR="/data/static/fix_orog"
SFC_CLIMO_INPUT_DIR="/data/static/climo_fields_netcdf"
...
#-----------------------------------------------------------------------
#
WFLOW_LAUNCH_SCRIPT_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/launch_FV3LAM_wflow.sh"
WFLOW_LAUNCH_LOG_FP="/data/experiments/test_CONUS_25km_GFSv15p2/log.launch_FV3LAM_wflow"
CRONTAB_LINE=""
#
#-----------------------------------------------------------------------
#
...
#-----------------------------------------------------------------------
#
SR_WX_APP_TOP_DIR="/opt/src/ufs-srweather-app"
HOMErrfs="/opt/src/ufs-srweather-app/regional_workflow"
USHDIR="/opt/src/ufs-srweather-app/regional_workflow/ush"
SCRIPTSDIR="/opt/src/ufs-srweather-app/regional_workflow/scripts"
JOBSDIR="/opt/src/ufs-srweather-app/regional_workflow/jobs"
SORCDIR="/opt/src/ufs-srweather-app/regional_workflow/sorc"
SRC_DIR="/opt/src/ufs-srweather-app/src"
PARMDIR="/opt/src/ufs-srweather-app/regional_workflow/parm"
MODULES_DIR="/opt/src/ufs-srweather-app/regional_workflow/modulefiles"
EXECDIR="/opt/src/ufs-srweather-app/bin"
FIXrrfs="/opt/src/ufs-srweather-app/regional_workflow/fix"
#FIXam="/data/experiments/test_CONUS_25km_GFSv15p2/fix_am"
FIXam="/data/static/fix_am"
FIXLAM="/data/experiments/test_CONUS_25km_GFSv15p2/fix_lam"
COMROOT=""
COMOUT_BASEDIR=""
TEMPLATE_DIR="/opt/src/ufs-srweather-app/regional_workflow/ush/templates"
UFS_WTHR_MDL_DIR="/opt/src/ufs-srweather-app/src/ufs_weather_model"
UFS_UTILS_DIR="/opt/src/ufs-srweather-app/src/UFS_UTILS"
EMC_POST_DIR="/opt/src/ufs-srweather-app/src/EMC_post"

EXPTDIR="/data/experiments/test_CONUS_25km_GFSv15p2"
LOGDIR="/data/experiments/test_CONUS_25km_GFSv15p2/log"
CYCLE_BASEDIR="/data/experiments/test_CONUS_25km_GFSv15p2"
GRID_DIR="/data/experiments/test_CONUS_25km_GFSv15p2/grid"
OROG_DIR="/data/experiments/test_CONUS_25km_GFSv15p2/orog"
SFC_CLIMO_DIR="/data/experiments/test_CONUS_25km_GFSv15p2/sfc_climo"
...
#-----------------------------------------------------------------------
#
GLOBAL_VAR_DEFNS_FP="/data/experiments/test_CONUS_25km_GFSv15p2/var_defns.sh"
# Try this at some point instead of hard-coding it as above; it's a more
# flexible approach (if it works).
# GLOBAL_VAR_DEFNS_FP=/opt/src/ufs-srweather-app/regional_workflow/ush/setup.sh
...
DATA_TABLE_TMPL_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/data_table"
DIAG_TABLE_TMPL_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/diag_table.FV3_GFS_v15p2"
FIELD_TABLE_TMPL_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/field_table.FV3_GFS_v15p2"
FV3_NML_BASE_SUITE_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/input.nml.FV3"
FV3_NML_YAML_CONFIG_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/FV3.input.yml"
FV3_NML_BASE_ENS_FP="/data/experiments/test_CONUS_25km_GFSv15p2/input.nml.base_ens"
MODEL_CONFIG_TMPL_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/model_configure"
NEMS_CONFIG_TMPL_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/templates/nems.configure"

CCPP_PHYS_SUITE_FN="suite_FV3_GFS_v15p2.xml"
CCPP_PHYS_SUITE_IN_CCPP_FP="/opt/src/ufs-srweather-app/src/ufs_weather_model/FV3/ccpp/suites/suite_FV3_GFS_v15p2.xml"
CCPP_PHYS_SUITE_FP="/data/experiments/test_CONUS_25km_GFSv15p2/suite_FV3_GFS_v15p2.xml"

DATA_TABLE_FP="/data/experiments/test_CONUS_25km_GFSv15p2/data_table"
FIELD_TABLE_FP="/data/experiments/test_CONUS_25km_GFSv15p2/field_table"
FV3_NML_FN="input.nml"   # This may not be necessary...
FV3_NML_FP="/data/experiments/test_CONUS_25km_GFSv15p2/input.nml"
NEMS_CONFIG_FP="/data/experiments/test_CONUS_25km_GFSv15p2/nems.configure"

FV3_EXEC_FP="/opt/src/ufs-srweather-app/bin/NEMS.exe"

LOAD_MODULES_RUN_TASK_FP="/opt/src/ufs-srweather-app/regional_workflow/ush/load_modules_run_task.sh"
#
#-----------------------------------------------------------------------
#
...
NEG_NY_OF_DOM_WITH_WIDE_HALO="-128"
#
#-----------------------------------------------------------------------
#
